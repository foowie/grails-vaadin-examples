...
import tieto.bank.state.DummyStateFactory;
import tieto.bank.state.MappedStateFactory;
import tieto.bank.state.StateFactory;
...
public class AccountDetailForm extends CustomComponent {
	...
	public AccountDetailForm() {
		...
		// stateFactory = new DummyStateFactory();
		stateFactory = new MappedStateFactory();
		stateHolder = new StateHolder(this, stateFactory.getState(null));
	}
	...
	public void setAccount(Account account) {
		...
		stateHolder.setState(stateFactory.getState(account));
	}
